...
namespace Tasks.Controllers
{
    public class PriorityController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,IsActive")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsActive")] Priority priority)
        {
            if (id != priority.Id)
            {
                return NotFound();
